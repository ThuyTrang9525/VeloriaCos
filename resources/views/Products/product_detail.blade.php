                ...
                <div class="w-1/2">
                    ...
                    <div class="pt-6 pb-5 flex items-center gap-4">
                        <div class="flex items-center border rounded-lg overflow-hidden w-1/7">
                            ...
                            <input class="w-12 text-center" type="number" value="1" min="1" step="1" id="product-quantity" name="quantity">
                        ...
                        <!-- Nút bấm Add to Cart -->
                        <button 
                            class="bg-pink-300 text-white px-6 py-3 rounded-lg w-5/6"
                            onclick="event.preventDefault(); document.getElementById('quantity-input-{{ $product->id }}').value = document.getElementById('product-quantity').value; document.getElementById('add-to-cart-form-{{ $product->id }}').submit();">
                            Add to Cart
                        </button>
                    </div>
